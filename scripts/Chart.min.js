                ...
                function(t, e, a) {
                    ...
                    (o.prototype = {
                        ...
                        (o.prototype.setValues = function(t, e) {
                            ...
                            if (
                                ((n.alpha = Math.max(0, Math.min(1, void 0 === l ? n.alpha : l))),
                                "alpha" === t)
                            )
                                return !1;
                            var d;
                                    ...
                                    getMaxBorderWidth: function(t) {
                                        for (
                                            ...
                                            (e = t[r]._model ? t[r]._model.borderWidth : 0),
                                                (a = t[r]._chart
                                                    ? t[r]._chart.config.data.datasets[n]
                                                          .hoverBorderWidth
                                                    : 0),
                                                (i = e > i ? e : i),
                                                (i = a > i ? a : i);
                            ...
                            r.extend(t.Controller.prototype, {
                                ...
                                updateHoverStyle: function(t, e, a) {
                                    ...
                                    for (n = 0, o = t.length; o > n; ++n)
                                        (i = t[n]),
                                            i &&
                                                this.getDatasetMeta(i._datasetIndex).controller[r](
                                                    i
                                                );
                                },
                    ...
                    e.exports = function(t) {
                        ...
                        (o.requestAnimFrame = (function() {
                            ...
                            (o.longestText = function(t, e, a, i) {
                                ...
                                i.font !== e &&
                                    ((n = i.data = {}), (r = i.garbageCollect = []), (i.font = e)),
                                    (t.font = e);
                                var l = 0;
                                o.each(a, function(e) {
            ...
            28: [
                function(t, e, a) {
                    ...
                    e.exports = function() {
                        var t = function(e, a) {
                            return (
                                (this.controller = new t.Controller(e, a, this)), this.controller
                            );
                        };
                        return (
                            (t.defaults = {
                                    ...
                                    if (n.display) {
                                        ...
                                        a.each(i.legendItems, function(t, e) {
                                            ...
                                            S
                                                ...
                                                : l + w > i.bottom &&
                                                  ((r = u.x =
                                                      r + i.columnWidths[u.line] + o.padding),
                                                  (l = u.y = i.top),
                                                  u.line++),
                                                y(r, l, t),
                                                (x[e].left = r),
                                ...
                                draw: function(a) {
                                    ...
                                    if (n.display) {
                                        ...
                                        if (u.drawBorder) {
                                            ...
                                            g
                                                ? ((H = U =
                                                      "top" === n.position ? i.bottom : i.top),
                                                  (H += j),
                                                  (U += j))
                                                : ((N = E =
                                                      "left" === n.position ? i.right : i.left),
                                                  (N += j),
                                                  (E += j)),
                                                l.beginPath(),
                                                l.moveTo(N, H),
                ...
                function(t, e, a) {
                    ...
                    e.exports = function(t) {
                        ...
                        function o(t, e) {
                            ...
                            return (
                                (a.font = s.fontString(u, e._titleFontStyle, e._titleFontFamily)),
                                s.each(e.title, g),
                                                ...
                                                function(e) {
                                                    ...
                                                    i.isValid() &&
                                                        (t.options.time.round &&
                                                            i.startOf(t.options.time.round),
                                                        a.push(
                                                            i.diff(t.firstTick, t.tickUnit, !0)
                                                        ));
                                                },
                                                t
                                            ),
                                    ...
                                    buildTicks: function() {
                                        ...
                                        if (
                                            ...
                                            for (var g = 0, p = a.units[g]; g < a.units.length; ) {
                                                ...
                                                (i.scaleSizeInUnits =
                                                    i.lastTick.diff(i.firstTick, i.tickUnit, !0) +
                                                    b +
                                                    v),
                                                    (i.displayFormat =
                                    ...
                                    getLabelForIndex: function(t, e) {
                                        ...
                                        return (
                                            "object" == typeof a.chart.data.datasets[e].data[0] &&
                                                (i = a.getRightValue(
                                                    a.chart.data.datasets[e].data[t]
                                                )),
                                    ...
                                    getValueForPixel: function(t) {
                                        ...
                                        return (
                                            ...
                                            e.firstTick
                                                .clone()
                                                .add(
                                                    i.duration(n, e.tickUnit).asSeconds(),
                                                    "seconds"
                                                )
                                        );
                                    },
